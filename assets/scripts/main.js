...
function initFormHandler() {
  ...
  let form_ = document.getElementById("new-recipe");
  console.log(form_);
  ...
  let r_card = document.createElement('recipe-card');
      
  // B7. TODO - Add the recipeObject data to <recipe-card> using element.data
  r_card.data = recipeObject;
  console.log(recipeObject);

  // B8. TODO - Append this new <recipe-card> to <main>
  document.querySelector("main").appendChild(r_card);
  ...
  let clr = document.getElementsByClassName("danger")[0];
